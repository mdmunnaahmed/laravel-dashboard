...
+(function (a) {
    ...
    (c.VERSION = "2.2.0"),
        ...
        (c.prototype.defaults = function () {
            return {
                ...
                onstyle:
                    this.$element.attr("data-onstyle") || c.DEFAULTS.onstyle,
                offstyle:
        ...
        (c.prototype.render = function () {
            ...
            var b =
                ...
                e = a('<span class="toggle-handle btn btn-default">').addClass(
                    b
                ),
                f = a('<div class="toggle-group">').append(c, d, e),
                g = a('<div class="toggle btn" data-bs-toggle="toggle">')
                    .addClass(
            ...
            var h =
                    this.options.width ||
                    Math.max(c.outerWidth(), d.outerWidth()) +
                        e.outerWidth() / 2,
                i =
                    this.options.height ||
                    Math.max(c.outerHeight(), d.outerHeight());
    ...
    (a.fn.bootstrapToggle = b),
        ...
        a(function () {
            a("input[type=checkbox][data-bs-toggle^=toggle]").bootstrapToggle();
        }),
        a(document).on(
            "click.bs.toggle",
            "div[data-bs-toggle^=toggle]",
            function (b) {
