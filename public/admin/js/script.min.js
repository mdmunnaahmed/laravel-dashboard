...
function dragStart(t) {
    (srcElement = this),
        ...
        t.dataTransfer.setData("text/html", this.outerHTML),
...
function init() {
    $(".kanban-items,.project-task tbody,.todo-task1 tbody")
        .sortable({
            connectWith: ".kanban-items,.project-task tbody,.todo-task1 tbody",
            stack: ".kanban-items  ul,.project-task tbody,.todo-task1 tbody",
        })
        .disableSelection(),
...
$(function () {
    ...
    (FooTable.MyFiltering = FooTable.Filtering.extend({
        ...
        $create: function () {
            ...
            var t = this,
                e = $("<div/>", {
                    class: "form-group atbd-select d-flex align-items-center adv-table-searchs__position my-md-25 my-15 mr-sm-20 mr-0 ",
                })
                    .append(
                        $("<label/>", {
            ...
            var s = $("<div/>", {
                class: "form-group atbd-select d-flex align-items-center adv-table-searchs__status my-md-25 mt-15 mb-0 mr-sm-30 mr-0",
            })
                .append(
                    $("<label/>", {
                        class: "d-flex align-items-center mb-sm-0 mb-2",
        ...
        _onStatusDropdownChanged: function (t) {
            var e = t.data.self,
                s = $(this).val();
            s !== e.statusDefault
                ? e.addFilter("position", s, ["position"])
                : e.removeFilter("position"),
                e.filter();
        },
        _onJobTitleDropdownChanged: function (t) {
            var e = t.data.self,
                s = $(this).val();
            s !== e.jobTitleDefault
                ? e.addFilter("status", s, ["status"])
                : e.removeFilter("status"),
                e.filter();
        },
        draw: function () {
            this._super();
            var t = this.find("position");
            t instanceof FooTable.Filter
                ? this.$status.val(t.query.val())
                : this.$status.val(this.statusDefault);
            var e = this.find("status");
            e instanceof FooTable.Filter
                ? this.$jobTitle.val(e.query.val())
                : this.$jobTitle.val(this.jobTitleDefault);
        },
    }));
!(function (t) {
    t("#external-events .fc-event").each(function () {
        t(this).data("event", { title: t.trim(t(this).text()), stick: !0 }),
            t(this).draggable({ zIndex: 999, revert: !0, revertDuration: 0 });
    });
    new Date();
    let e = {
            id: 1,
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (l) {
            ...
            o.render(),
                t(".fc-button-group .fc-listMonth-button").prepend(
...
!(function () {
    ...
    function e(e, t, l, r, o) {
        ...
        new google.maps.Marker({
            position: s,
            icon: o || "img/markar-icon.png",
        }).setMap(a);
    }
    $(".google-map").length &&
        google.maps.event.addDomListener(window, "load", function () {
            $("#google-map-basic").length &&
                e("google-map-basic", 50.797897, -1.077641);
            ...
            $("#google-map-theme").length &&
                e("google-map-theme", 50.797897, -1.077641, [
                    ...
                    },
                    {
                        featureType: "road",
                        elementType: "geometry",
                        stylers: [{ color: "green" }, { lightness: "0" }],
                    },
                    {
                        featureType: "transit",
                        elementType: "geometry",
...
$("#sb_location-month-tab").on("shown.bs.tab", function () {
    $(regionMapM).vectorMap({
        ...
        regionStyle: {
            initial: { fill: "#E3E6EF" },
            hover: { fill: "#5F63F2", "fill-opacity": 1 },
        },
        markerStyle: {
            initial: {
                fill: "#5F63F215",
...
!(function (t) {
    ...
    if (r) {
        ...
        for (var c = L.markerClusterGroup(), l = 0; l < t.length; l++) {
            var h = (o = t[l])[2];
            (s = L.marker(new L.LatLng(o[0], o[1]), { title: h })).bindPopup(h),
                c.addLayer(s);
        }
        e.addLayer(c);
    }
...
!(function (e) {
    ...
    a &&
        ...
        e(window)
            .on("resize", function () {
                window.innerWidth;
                e(this).width() <= 767.98
                    ? (e(".navbar-right__menu").appendTo(
                          ".mobile-author-actions"
                      ),
                      e(".contents").addClass("expanded"),
                      e(".sidebar ").addClass("collapsed"))
                    : e(".navbar-right__menu").appendTo(".navbar-right");
            })
            .trigger("resize"),
        e(window)
            .bind("resize", function () {
                window.innerWidth;
                e(this).width() > 767.98 &&
                    e(".atbd-mail-sidebar").addClass("show");
            })
            .trigger("resize"),
        e(window)
            .bind("resize", function () {
        ...
        e(window)
            .bind("resize", function () {
                window.innerWidth;
                e(this).width() <= 991.98 &&
                    e(".menu-horizontal").appendTo(".mobile-nav-wrapper");
            })
            .trigger("resize"),
        e(".btn-search").on("click", function () {
            e(this).toggleClass("search-active"),
                e(".mobile-search").toggleClass("show"),
                e(".mobile-author-actions").removeClass("show");
        }),
        e(".kanban-items li").hover(function () {
            e(this).toggleClass("active");
        }),
        e(".btn-author-action").on("click", function () {
            e(".mobile-author-actions").toggleClass("show"),
                e(".mobile-search").removeClass("show"),
                e(".btn-search").removeClass("search-active");
        }),
            ...
            document
                ...
                .addEventListener("click", function () {
                    ...
                    (e = ".payment-invoice"),
                        ...
                        (a = document.querySelector(e).innerHTML),
    ...
    e(".banner-slider").each(function () {
        ...
        e(".dropdown-clickEvent a").on("click", function (t) {
            ...
            e(".atbd-message").prepend(a),
                ...
                setTimeout(function () {
                    e(".atbd-message").empty(),
                        e(".atbd-message").removeClass("show");
                }, 3e3);
        }),
    ...
    n.classList.add("overlay-dark"),
        ...
        e("#event-category").select2({
            minimumResultsForSearch: 1 / 0,
            placeholder: "Project Category",
            allowClear: !0,
        }),
        e("#category-member").select2({
            minimumResultsForSearch: 1 / 0,
            placeholder: "Project Category",
        ...
        e('#customSwitch1, input[name="intervaltype"]').on(
            "click",
            function () {
                e(".monthly,#monthly").toggleClass("active"),
                    e(".yearly,#yearly").toggleClass("active");
            }
        ),
    ...
    Array.from(u).forEach((e) =>
        ...
        e("#ueberTab a").on("click", function (t) {
            for (
                otherTabs = e(this).attr("data-secondary").split(","), i = 0;
                i < otherTabs.length;
                i++
            )
                (nav = e('<ul class="nav d-none" id="tmpNav"></ul>')),
                    nav.append(
        ...
        e("#switch-spin").on("change", function () {
            e(this).is(":checked")
                ? e(".spin-embadded").addClass("spin-active")
                : e(".spin-embadded").removeClass("spin-active");
        }),
        e(".kb__select-wrapper select,.tagSelect-rtl select").select2({
            dir: "rtl",
            dropdownAutoWidth: !0,
            dropdownParent: e(
    ...
    e("#switch-slider").on("change", function () {
        e(this).is(":checked")
            ? (e(".slider-wrapper").addClass("disabled"),
              e(".slider-basic , .slider-range").slider({ disabled: "true" }))
            : (e(".slider-wrapper").removeClass("disabled"),
              e(".slider-basic, .slider-range").slider({ disabled: "false" }));
    }),
        e(".slider-basic").slider({
            range: "min",
            min: 0,
            max: 50,
            value: 20,
        ...
        e("#switch-slider").on("change", function () {
            e(this).is(":checked")
                ? (e(".slider-wrapper").addClass("disabled"),
                  e(".slider-basic , .slider-range").slider({
                      disabled: "true",
                  }))
                : (e(".slider-wrapper").removeClass("disabled"),
                  e(".slider-basic, .slider-range").slider({
    ...
    function k(e) {
        e.preventDefault(),
            "basic" == this.dataset.drawer
                ? (v.classList.remove("account"),
                  v.classList.remove("profile"),
                  v.classList.add("basic"),
                  v.classList.add("show"),
                  g.classList.add("show"))
                : "area" == this.dataset.drawer
                ? (b.classList.add("show"), y.classList.add("show"))
                : "account" == this.dataset.drawer
                ? (v.classList.remove("basic"),
                  v.classList.remove("profile"),
                  v.classList.add("account"),
                  v.classList.add("show"),
                  g.classList.add("show"))
                : "profile" == this.dataset.drawer &&
                  (v.classList.remove("basic"),
                  v.classList.remove("account"),
                  v.classList.add("profile"),
                  v.classList.add("show"),
                  g.classList.add("show"));
    }
    function C() {
    ...
    h && h.forEach((e) => e.addEventListener("click", k)),
        g && g.addEventListener("click", C),
        f && f.forEach((e) => e.addEventListener("click", C)),
    ...
    function D() {
        "level-one" == this.dataset.drawer
            ? (w.classList.add("level-one"),
              w.classList.add("show"),
              w.classList.remove("level-two"),
              g.classList.add("show"))
            : "level-two" == this.dataset.drawer &&
              (w.classList.add("level-two"),
    ...
    x &&
        ...
        e(".menu-wrapper " + F).on("click", function (t) {
            e(this).parent().hasClass("has-submenu") && t.preventDefault(),
                e(this)
                    .toggleClass("open")
                    .siblings(A)
                    .slideToggle()
        ...
        e("#id_label_single").select2({
            placeholder: "All",
            dropdownCssClass: "category-member",
            allowClear: !0,
        }),
        e("#select-search,.kb__select").select2({
            placeholder: "Search a person",
            dropdownCssClass: "category-member",
            allowClear: !0,
        }),
        e("#select-alerts2").select2({
            placeholder: "Alerts",
            dropdownCssClass: "alert2",
            allowClear: !0,
        }),
        e("#select-option2").select2({
            placeholder: "Select an option...",
            dropdownCssClass: "option2",
            allowClear: !0,
        }),
        e("#select-tag,#select-tag2").select2({
        ...
        e("#mail-to,#reply-to,#reply-to2").select2({
            placeholder: "",
        ...
        e(".like-icon").click(function () {
            e(this).find(".icon").toggleClass("lar"),
                e(this).find(".icon").toggleClass("las");
        }),
        e(".ap-button .follow").click(function () {
            e(this).find(".follow-icon").toggleClass("la-user-plus"),
                e(this).find(".follow-icon").toggleClass("la-user-check"),
                e(this).toggleClass("active");
        }),
        ...
        e(".price-value").text(
            "$" +
                e(".price-slider").slider("values", 0) +
                " - $" +
                e(".price-slider").slider("values", 1)
        ),
            ...
            e(a).on("click", function () {
                e(this)
                    ...
                    e(this)
                        ...
                        .fadeIn("slow")
                        .addClass("active"),
                    e("body").fadeIn("slow").addClass("is-open");
            });
        }),
        e("body").on("click", function (t) {
            t.target.closest(".open-popup-modal, .popup-content") ||
                (e(".popup-overlay, .popup-content")
                    .fadeIn("slow")
                    .removeClass("active"),
                e("body").fadeIn("slow").removeClass("is-open"));
        }),
    ...
    function I(t) {
        t.preventDefault(),
            "label" == this.dataset.trigger
                ? z.classList.add("show")
                : "compose" == this.dataset.trigger && R.classList.add("show"),
            e(t.target).hasClass("label-close") && z.classList.remove("show");
    }
    function Q(e) {
        e.preventDefault(),
            "label" == this.dataset.trigger
                ? z.classList.remove("show")
                : "compose" == this.dataset.trigger &&
                  R.classList.remove("show");
    }
    null !== q &&
        null !== O &&
        (q.addEventListener("click", I), M.addEventListener("click", I)),
        null !== O &&
            null !== B &&
            (O.addEventListener("click", Q), B.addEventListener("click", Q));
    ...
    function j(t) {
        t.preventDefault(),
            "light" === this.dataset.layout
                ? (e("ul.l_sidebar li a,.l_sidebar a").removeClass("active"),
                  e(this).addClass("active"),
                  e("body").removeClass("layout-dark"),
                  e("body").addClass("layout-light"))
                : "dark" === this.dataset.layout
                ? (e("ul.l_sidebar li a,.l_sidebar a").removeClass("active"),
                  e(this).addClass("active"),
                  e("body").removeClass("layout-light"),
                  e("body").addClass("layout-dark"))
                : "side" === this.dataset.layout
                ? (e("ul.l_navbar li a,.l_navbar a").removeClass("active"),
                  e(this).addClass("active"),
                  e("body").removeClass("top-menu"),
                  e("body").addClass("side-menu"))
                : "top" === this.dataset.layout &&
                  (e("ul.l_navbar li a,.l_navbar a").removeClass("active"),
                  e(this).addClass("active"),
                  e("body").removeClass("side-menu"),
                  e("body").addClass("top-menu"));
    }
    $ &&
    ...
    function X(t, a, s) {
        var i, l;
        try {
            (l = e.datepicker.parseDate(s, t)),
                e.datepicker.parseDate(s, a) < l && ((i = t), (t = a), (a = i));
        } catch (e) {}
    ...
    W &&
        W.addEventListener("click", function (t) {
            t.preventDefault(),
                ...
                e(".customizer-overlay").addClass("show");
        }),
        N &&
            Y &&
            (N.addEventListener("click", G), Y.addEventListener("click", G)),
        e(".search-toggle").on("click", function (t) {
            t.preventDefault(),
                e(this).toggleClass("active"),
                e(".search-form-topMenu").toggleClass("show");
        }),
        ...
        e(".testimonial-slider3-for").slick({
            rtl: !0,
            slidesToShow: 1,
            slidesToScroll: 1,
            arrows: !0,
        ...
        (e.fn.dateRangePicker = function (t) {
            ...
            function n(s, i) {
                var l, o;
                (s = s.split(t.rangeSeparator)).length > 0
                    ? ((l = e.datepicker.parseDate(i, s[0])),
                      s.length > 1 && (o = e.datepicker.parseDate(i, s[1])),
                      (a = { start: l, end: o }))
                    : (a = null);
            }
            return (
                    ...
                    if (l.rangeStart) {
                        if (((l.inline = !1), (o = l.rangeStart) !== a)) {
                            var r = s.datepicker("option", "dateFormat"),
                                n = X(o, a, r);
                            if (
                                (s.val(n.start + t.rangeSeparator + n.end),
                                (l.rangeStart = null),
                                t.useHiddenAltFields)
                            ) {
                ...
                this.each(function () {
                    s.is("input") && s.datepicker(t),
                        s.wrap('<div class="dateRangeWrapper"></div>');
                })
            );
        }),
        e(document).ready(function () {
            e("#txtDateRange").dateRangePicker({
                showOn: "focus",
                rangeSeparator: " - ",
                dateFormat: "dd/mm/yy",
                useHiddenAltFields: !0,
                constrainInput: !0,
            });
        }),
        e(window).on("load", function () {
