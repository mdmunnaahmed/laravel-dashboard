        ...
        <div class="navbar-right">
            <ul class="navbar-right__menu">
                ...
                <li class="nav-flag-select">
                    <div class="dropdown-custom">
                        <a href="javascript:;" class="nav-item-toggle"><img src="{{ asset('admin/img/flag.png') }}" alt="" class="rounded-circle"></a>
                        <div class="dropdown-wrapper dropdown-wrapper--small">
                            <a href="#"><img src="{{ asset('admin/img/eng.png') }}" alt=""> English</a>
                            <a href="#"><img src="{{ asset('admin/img/ger.png') }}" alt=""> German</a>
                            <a href="#"><img src="{{ asset('admin/img/spa.png') }}" alt=""> Spanish</a>
                            <a href="#"><img src="{{ asset('admin/img/tur.png') }}" alt=""> Turkish</a>
                        </div>
                    </div>
                </li>
