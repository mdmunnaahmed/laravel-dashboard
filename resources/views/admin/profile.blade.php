                            ...
                            <div class="card-body text-center pt-sm-30 pb-sm-0  px-25 pb-0">
                                ...
                                <div class="account-profile">
                                    <div class="ap-img w-100 d-flex justify-content-center">
                                        ...
                                        <img class="ap-img__main rounded-circle mb-3  wh-120 d-flex bg-opacity-primary" src="{{ !empty($admin_data->profile_img) ? url('admin/img/author/' . $admin_data->profile_img) : url('admin/img/no-img.jpg') }}" alt="profile">
                                    </div>
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <div class="border-0  flex-1 position-relative">
                                                            <div class="pt-20 outline-0 pb-2 pr-0 pl-0 rounded-0 position-relative border-bottom" tabindex="-1">
                                                                <span class="ap-profile-image bg-opacity-secondary rounded-circle d-block position-absolute" style="background-image:url('../../../../img/ap-author.html'); background-size: cover;"></span>
                                                ...
                                                <div class="card-body px-25 py-20 ap-main-post__footer">
                                                    <div class="ap-post-content-comment">
                                                        <div class="pt-0 outline-0 pb-0 pr-0 pl-0 rounded-0 position-relative d-flex align-items-center" tabindex="-1">
                                                            <span class="rounded-circle d-block position-absolute wh-36" style="background-image:url('../../../../img/ap-author.html'); background-size: cover;"></span>
