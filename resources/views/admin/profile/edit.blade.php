                            ...
                            <div class="account-profile border-bottom pt-25 px-25 pb-0 flex-column d-flex align-items-center ">
                                <div class="ap-img mb-20 pro_img_wrapper">
                                    ...
                                    <label for="profile_upload">
                                        <img class="ap-img__main rounded-circle wh-120" id="previewProfile" src="{{ !empty($profile_edit_data->profile_img) ? url('admin/img/author/' . $profile_edit_data->profile_img) : url('admin/img/no-img.jpg') }}" alt="profile">
